<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:nucspec  Version:1.1.0.0 - Wed Jun 05 15:44:35 UTC 2024 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="nucspec:First_Last[nucspec:first_record]">
      <sch:assert test="nucspec:last_record >= nucspec:first_record">
        <title>nucspec:First_Last[nucspec:first_record]/Rule</title>
  ...
  <sch:pattern>
    <sch:rule context="nucspec:First_Last[nucspec:last_record]">
      <sch:let name="local_id" value="../../../pds:Local_Internal_Reference/pds:local_identifier_reference"/>
      <sch:let name="record_count" value="number(//*[pds:local_identifier=$local_id]/pds:records)"/>
      <sch:let name="last_record" value="number(nucspec:last_record)"/>
      <sch:assert test="$record_count >= $last_record">
        <title>nucspec:First_Last[nucspec:last_record]/Rule</title>
